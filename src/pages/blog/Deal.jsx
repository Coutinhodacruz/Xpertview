...
import image from "../../assets/comfort-zone-lu2e1jy2.webp";
        ...
        <div>
            ...
            <div className="p-6 mx-auto bg-white rounded-md">
                <header className="mb-6">
                    <h1 className="text-3xl font-bold mb-4">If you are limited by your comfort zone</h1>
                </header>
                ...
                <img src={image} alt="alt"
                     className={'w-[200px] h-[150px] sm:w-[450px] sm:h-[300px] my-[20px] lg:w-[600px] lg:h-[400px] md:mx-auto'}/>
            </div>
